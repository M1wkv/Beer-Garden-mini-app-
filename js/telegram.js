...
function applyLayoutMetrics() {
  ...
  setPx("--home-grid-cart-lift", (24 * verticalScale) + (60 * layoutScale) + (7 * layoutScale) - (45 * verticalScale));
  ...
  setPx("--menu-section-gap", 26.4 * verticalScale);
  ...
  scheduleHomeGridPositionUpdate?.();
}
...
function initLayoutMetrics() {
  ...
  applyLayoutMetrics();
  document.fonts?.ready?.then(() => scheduleHomeGridPositionUpdate?.());
  window.visualViewport?.addEventListener("resize", applyLayoutMetrics);
  window.addEventListener("resize", applyLayoutMetrics);
  window.addEventListener("load", () => scheduleHomeGridPositionUpdate?.());
